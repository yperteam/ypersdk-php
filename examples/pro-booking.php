...
$applicationKey = "7022265601";
$applicationSecret = "m3ctRX8D8Q4zJV928uLaaUj8i2v6SH";

$pro_id = "5c08eaa1b2aa3ff829381032";
$pro_secret = "36jgJm99d5JFwNU";
try {
    ...
    try {
        $res = $proService->post_prebook([
            ...
            "delivery_start" => "2019-04-28 16:00:00.000Z", // Heure de début de livraison
            "delivery_end" => "2019-04-28 17:00:08.000Z", // Defaults to "delivery_start" + 1 hour
            "order" => [
